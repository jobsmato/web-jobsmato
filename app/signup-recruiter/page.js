  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center bg-gray-50 overflow-hidden pt-32">
      ...
      <div className="relative z-20 bg-white p-8 rounded shadow-md w-full max-w-xl">
        ...
        <h2 className="text-2xl font-bold mb-6 text-center">Recruiter Signup</h2>
        <form onSubmit={handleSubmit}>
          ...
          >
            {isSubmitting ? "Signing up..." : "Signup as Recruiter"}
          </button>
        </form>
        {/* Login Link */}
        <div className="text-center">
          <p className="text-gray-600">Already have an account? <Link href="/login-recruiter" className="text-primary hover:text-primary/80">Login here</Link></p>
        </div>
      </div>
    </div>
  );
